<div class="shadow overflow-hidden sm:rounded-md">
    <div class="px-4 py-5 bg-white sm:p-6">
        ...
        <div class="w-full mt-4">
            ...
            <div class="mt-1 relative rounded-md shadow-sm">
                <input id="email" wire:model="email" type="email" class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 w-full" placeholder="{{ __('Email Address') }}">
            </div>
            @error('email')
            <p class="text-sm mt-2 text-red-500">
                {{ $message }}
